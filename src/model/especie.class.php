...
/**
 * [Description especieModel]
 * Classe para interagir com a tabela de especie
 */
class especieModel
{
    // Atributos
    ...
    public function insert()
    {
        ...
        try {
            $statement = $pdo->prepare(
                "INSERT INTO especie (nome) VALUES (:nome)"
            );
    ...
    public function update()
    {
        ...
        try {
            $statement = $pdo->prepare(
                "UPDATE especie SET nome = :nome WHERE cod = :cod"
            );
    ...
    public function delete()
    {
        ...
        try {
            $statement = $pdo->prepare(
                "DELETE FROM especie WHERE cod = :cod"
            );
    ...
    public function read()
    {
        ...
        try {
            $statement = $pdo->prepare(
                "SELECT * FROM especie WHERE cod = :cod"
            );
    ...
    public function search($where)
    {
        ...
        try {
            $statement = $pdo->prepare(
                "SELECT * FROM especie WHERE " . $where
            );
